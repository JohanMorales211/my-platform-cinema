...
export class AboutComponent {
  ...
  welcomeText: string = `
    ...
    <p>Mi nombre es Johan Morales, y soy un apasionado Ingeniero de Software con un gran interés por crear experiencias de usuario atractivas y funcionales. Johan Films es un reflejo de mi dedicación y amor por la tecnología.</p>
